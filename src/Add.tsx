                      ...
                      <>
                        <Popover.Button
                          className={`
                            ...
                            group inline-flex items-center text-base font-medium text-white hover:text-opacity-100 focus:outline-none focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-opacity-75 ml-2`}
                        >
                          <span>ℹ️</span>
                        </Popover.Button>
                        <Transition
                        ...
                        >
                          <Popover.Panel className="absolute left-1/2 z-1 mt-3 w-auto -translate-x-1/2 transform px-4 sm:px-0 lg:max-w-3xl bg-white">
